...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href={{ route('front_liste') }}>Inteligence<span>Artificiel</span></a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          <li class="nav-item active"><a href= {{ route('front_liste') }} class="nav-link">Acceuil</a></li>
	          
	          <li class="nav-item"><a href={{ route('index')}} class="nav-link">Admin</a></li>
	        </ul>
	      </div>
	    </div>
	  </nav>
